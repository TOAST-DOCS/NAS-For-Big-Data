...
스냅숏을 즉시 생성합니다. 이름은 32자 이내의 영문자와 숫자, '-', '\_', '.'만 입력할 수 있습니다. 각 스냅숏은 스토리지 내에서 고유한 이름을 가져야 합니다.

#### 스냅숏 복원

스토리지를 스냅숏이 생성된 시점으로 복원합니다. 스냅숏을 복원하려면 고객 센터에 문의하세요.
